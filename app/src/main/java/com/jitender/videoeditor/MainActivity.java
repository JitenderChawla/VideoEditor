package com.jitender.videoeditor;
...
//                        Intent intent = new Intent(Main2Activity.this, PreviewImageActivity.class);
//                        intent.putExtra(FILEPATH, filePath);
//                        startActivity(intent);
                    } else if (choice == 4) {
//                        Intent intent = new Intent(Main2Activity.this, AudioPreviewActivity.class);
//                        intent.putExtra(FILEPATH, filePath);
//                        startActivity(intent);
                    } else if (choice == 8) {
                        choice = 9;
